  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(5,5,5,1) 0%, rgba(20,10,50,1) 40%, rgba(0,0,0,1) 100%)",
        }}
      >
        ...
        <div className="container mx-auto text-center px-4 hero-content">
          ...
          <p className="text-4xl">
            Revolutionize with the power of AI. Automate, optimize, and scale
            like never before.
          </p>
        </div>
      </header>
      ...
      <section className="container mx-auto my-20 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-5">
          <div className="card card-compact bg-base-300 w-150 shadow-xl">
            <figure>
              <img src="/image_resize.png" alt="Resize" />
            </figure>
            <div className="card-body items-center text-center">
              <h2 className="card-title">Social Media Resizer using AI</h2>
              <p>
                Resize your images according to different social media platfroms
                using AI to auto detect faces and text
              </p>
            </div>
          </div>
          ...
          <div className="card card-compact bg-base-300 w-150 shadow-xl">
            <figure>
              <img src="/video.jpg" alt="Video Compress" />
            </figure>
            <div className="card-body items-center text-center">
              <h2 className="card-title">Video Compression</h2>
              <p>
                Compress your videos upto 60% to 70% and download them from
                anywhere{" "}
              </p>
      ...
      <section className="bg-primary-content text-white py-20">
        <div className="container mx-auto text-center px-4">
          ...
          <p className="text-lg mb-8">
            Sign up today and start using our AI-powered platform to automate
            your processes.
          </p>
      ...
      <footer className="bg-transparent text-neutral-content py-8">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-4 text-sm">Created by Sachin Jakhar</p>
